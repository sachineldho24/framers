...
During the planning phase, all output goes into `/plan/` as markdown files. No application code, no package installs, no files outside `/plan/` (except this AGENTS.md). The 10 planned documents are numbered `00` through `09`.
